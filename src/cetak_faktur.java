...
public class cetak_faktur extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtcari.setBackground(new java.awt.Color(0, 0, 255));
        txtcari.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        txtcari.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Zoom.png"))); // NOI18N
        ...
        txtcetak.setBackground(new java.awt.Color(153, 0, 153));
        txtcetak.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtcetak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Print.png"))); // NOI18N
        ...
        Keluar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cancel.png"))); // NOI18N
...
("jdbc:mysql://127.0.0.1/koneksiku", "root", "");
...
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("                       *** FAKTUR PENJUALAN HANDPHONE ***"+
                                 "\n     Jl. Raya Telang Kec.Kamal Kab.Bangkalan 69162"+
                                 "\n                                  Telp.(021)8901348"+
                                 "\n============================================"+
                                 "\n=========TRANSAKSI PEMBELIAN HANDPHONE==========" + "\n" 
                                      + "ID TRANSAKSI                                    : " + rs.getString(1)+ "\n" 
                                      + "ID CUSTOMER                                    : " + rs.getString(2)+ "\n"     
                                      + "ID HANDPHONE                                 : " + rs.getString(3)+ "\n"
                                      + "JUMLAH BELI                                     : " + rs.getString(4)+ "\n"
                                      + "TOTAL HARGA                                   : " + rs.getString(5) +"\n"
                                      + "TANGGAL BELI                                   : " + rs.getString(6) +"\n"
                                      
                                      +
                                
                                 "\n============================================"+
                                 "\n    Terimasih Telah Membeli Produk HANDPHONE Dari Kami,"+
